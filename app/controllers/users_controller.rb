class UsersController < ApplicationController
  ...
  def update
    begin
      user = UserServiceClient.instance.update_user_by_id params[:id].to_i, user_params
  ...
  def edit
    @user = UserServiceClient.instance.get_user_by_id params[:id].to_i
  end

  def destroy
    user = UserServiceClient.instance.get_user_by_id params[:id].to_i
    UserServiceClient.instance.delete_user_by_id user.id
