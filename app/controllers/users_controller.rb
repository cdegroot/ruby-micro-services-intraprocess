class UsersController < ApplicationController
  ...
  def index
    @users = UserService.client.get_all_users
  end
  ...
  def create
    begin
      user = UserService.client.create_user user_params
  ...
  def update
    begin
      user = UserService.client.update_user_by_id params[:id].to_i, user_params
  ...
  def edit
    @user = UserService.client.get_user_by_id params[:id].to_i
  end
